...
document.getElementById("cont").style.backgroundColor = colors[randomNumber2];
document.getElementById("h2").style.backgroundColor = colors[randomNumber2 +1];
color.innerText = colors[randomNumber2];
});
